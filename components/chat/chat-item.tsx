       ...
       <FileIcon className="h-10 w-10 fill-indigo-200 stroke-indigo-400"/>
        ...
        >
         PDF FILE
           ...
           {canDeleteMessage && (
            <div className="group-hover:flex items-center gap-x-1 absolute top-2 right-2 bg-white dark:bg-zinc-800 border rounded-sm shadow-md z-10 px-2 py-1">
                {canEditMessage && (
                  <ActionTooltip label="Edit">
                   <Edit onClick={()=>setIsEditing(true)} 
                    className="cursor-pointer w-4 h-4 text-zinc-500 hover:text-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-200 transition"/> 
                  </ActionTooltip>  
                )}
